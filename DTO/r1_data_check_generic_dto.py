class R1DataCheckGenericDto:

    def __init__(self, id_r1_data_check_generic=None, init_event=None, end_event=None, init_pixel=None, end_pixel=None,
                 init_sample=None, end_sample=None,
                 init_subrun=None, end_subrun=None, type_of_gap_calc=None, list_of_module_in_detail=None):
        self.__id_r1_data_check_generic = id_r1_data_check_generic
    ...
    @property
    def id_r1_data_check_generic(self):
        return self.__id_r1_data_check_generic
    ...
    @id_r1_data_check_generic.setter
    def id_r1_data_check_generic(self, value):
        self.__id_r1_data_check_generic = value
...
def create_r1_data_check_generic(id_r1_data_check_generic, init_event, end_event, init_pixel, end_pixel, init_sample,
                                 end_sample,
                                 init_subrun, end_subrun, type_of_gap_calc, list_of_module_in_detail):
    dto = R1DataCheckGenericDto()
    dto.id_r1_data_check_generic = id_r1_data_check_generic
